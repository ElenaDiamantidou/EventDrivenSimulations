...
function [ Total_Arrivals, Arrivals_to_Stations ] = ArrivalSystem1( Lambda, Stations, Arrivals_to_Stop )
Sim_Flag = true;
Time = 0;
...
%paragei to gegonos2 se ekthetiko xrono me mesi timi lambda
